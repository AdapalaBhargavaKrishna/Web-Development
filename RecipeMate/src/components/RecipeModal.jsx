...
const RecipeModal = ({ meal, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 ">
        <div className="bg-[#f8fbff] pl-6 pr-6 pt-4 rounded-lg shadow-lg w-[80vw] h-[90vh] relative overflow-y-auto hide-scrollbar ">
        <img onClick={onClose} className='absolute top-3 right-3 text-xl' src="/img/close.svg" alt=""/>
          ...
          <div className=" shadow-md p-4 rounded-xl flex flex-col items-center bg-blue-50 ani">
          ...
          <div id="right" className='w-1/2 m-2 rounded-xl max-h-[38.5rem] shadow-md p-2 pl-10 pr-10 bg-blue-50 overflow-y-auto hide-scrollbar ani'>
            <h1 className="mt-4 font-bold text-xl mb-2 text-center">Instructions:</h1>
            <p className="text-sm">{meal.strInstructions.split()}</p>
          </div>
          </div>
          {meal.strYoutube && (
                <div className="mt-4 bg-red-200 max-h-20 rounded-lg shadow-md p-2 ani">
