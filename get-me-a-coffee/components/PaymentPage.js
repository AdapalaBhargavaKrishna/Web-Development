...
{/* <div className='cover w-full bg-red-50 relative'>
                <img className='object-cover w-full h-48 md:h-[350px] shadow-blue-700 shadow-sm' src="https://c10.patreonusercontent.com/4/patreon-media/p/campaign/75882/264067ce3818401b9f1fbfd1e661c6bf/eyJ3IjoxOTIwLCJ3ZSI6MX0%3D/9.jpeg?token-time=1746316800&token-hash=mqMT0elUDzl6aYuIILqjVQEAwvsoT4TeISLnbi_bRoA%3D" alt="" />
                <div className='absolute -bottom-20 right-[33%] md:right-[46%] border-white overflow-hidden border-2 rounded-full size-36'>
                    <img className='rounded-full object-cover size-36' width={128} height={128} src="https://c10.patreonusercontent.com/4/patreon-media/p/campaign/75882/7399919d08e4470b9a8094f18e47d311/eyJoIjoxMDgwLCJ3IjoxMDgwfQ%3D%3D/4.jpg?token-time=1745798400&token-hash=z4pH1XGoLv_xcq8ODcVxDaCdZzjqlTmxTV4tWyMUx5k%3D" alt="" />
                </div>
            </div> */}