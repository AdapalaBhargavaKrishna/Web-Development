  ...
  return (
    <>
      <div className="flex justify-center flex-col gap-4 items-center text-white h-[44vh] px-5 md:px-0 text-xs md:text-base  ">
        <div className="font-bold flex gap-6 md:gap-2 md:text-5xl justify-center items-center text-3xl">Get Me a Coffee <span><img className="invertImg" src="/tea.gif" width={80} alt="" /></span></div>
