      ...
      <div className='bg-[#f4f9ff] min-h-screen font-sans text-gray-800'>
        <div className='flex flex-col items-center max-w-4xl mx-auto text-center px-4 sm:px-6 md:px-14 pt-20 pb-10'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center gap-3 mt-10 bg-white p-4 rounded-xl w-full max-w-2xl shadow-md transition duration-200 hover:shadow-lg'>
            ...
            />
            <button className='flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg text-sm whitespace-nowrap shadow-lg hover:scale-105 transition'>
        ...
        {summary &&
          <div className='flex flex-col w-[65%] mx-auto bg-white shadow-md items-center rounded-xl overflow-hidden'>
            <div className='w-full relative'>
              <img src="https://i.ytimg.com/vi/JuAxi3mniFQ/hqdefault.jpg" className='w-full h-64 object-cover rounded-xl' alt="" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-xl"></div>
              <div className='absolute right-0 bottom-0 left-0 text-white p-4'>
                <h1 className='text-lg font-semibold'>Match The Voice To The Person</h1>
            ...
            <div className='flex items-center justify-between bg-neutral-50 p-5 w-full'>
              ...
              <div className='flex'>
                <button className='flex items-center gap-2 mx-4'><img className='w-8 h-8' src={playsvg} alt="" /><span>Watch Video</span></button>
        ...
        <div className='flex mx-52'>
          ...
          <div className='m-4 bg-white rounded-xl shadow-md w-[65%] max-h-[70vh] pb-10 overflow-y-scroll'>
            <div className='p-5'>
            ...
            <div className=' space-x-2'>
              <div className='flex'>
                <img src="https://i.ytimg.com/vi/JuAxi3mniFQ/hqdefault.jpg" className='h-24 rounded-3xl object-cover p-4' alt="" />
              ...
              <hr className='my-8' />
              <div className='flex'>
                <img src="https://i.ytimg.com/vi/JuAxi3mniFQ/hqdefault.jpg" className='h-24 rounded-3xl object-fill p-4' alt="" />
                <div className='space-y-2 relative'>
                  <img src={completesvg} className='top-0 right-4 absolute w-7 h-7' alt="" />
                  <h1 className='font-semibold text-sm md:text-base'>
                    Match The Voice To The Person
